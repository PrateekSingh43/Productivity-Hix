...
import { useLiveTelemetry, syncActivity } from "@features/timeline";
import { verifyDeviceCode } from "../api/client";
          ...
          >
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border-subtle">
              <button
                ...
                disabled={syncing}
                className="inline-flex items-center gap-1.5 rounded-xl border border-border-default bg-bg-secondary px-3 py-1.5 text-xs font-medium text-text-secondary hover:text-text-primary hover:bg-bg-tertiary transition-colors disabled:opacity-50 cursor-pointer"
              >
                <RefreshCw
                  size={12}
            ...
            {pairingSuccess ? (
              ...
              >
                ...
                <button
                  ...
                  className="rounded-xl bg-accent-default px-4 py-2 text-xs font-semibold text-white hover:bg-accent-hover transition-colors disabled:opacity-50 shadow-xs cursor-pointer"
                >
